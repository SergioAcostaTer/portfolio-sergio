    ...
    return (
        <>
            ...
            <a href={url} target="_blank" rel="noreferrer" className="aspect-square">
                <div style={{
                ...
                }} className={`cursor-pointer w-full h-full md:w-[90px] md:h-[90px] m:w-[120px] m:h-[120px] rounded-[20px] transition-all duration-150 hover:scale-[1.04] flex items-center justify-center relative flex flex-col `}>
                    ...
                    <img src={img} alt="linkedin" className="w-[50px] h-[50px] mt-[10px]" />
                    <p className="text-white text-sm font-bold capitalize ">{show[discordUser.discord_status]}</p>
                </div>
            </a>
